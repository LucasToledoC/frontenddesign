// IMPORTA OS MODULOS QUE SERÃO UTILIZADOS NA APLICAÇÃO
const express = require("express");
// PERMITE ACESSO AS APLICAÇÕES DE DIFERENTES DOMINIOS
...
app.post("/clientes", async(req,res)=>{
    ...
    try{
        ...
        // ADICIONO E LISTA OS NOVOS CLIENTES NO ARRAY
        ...
        // RETORNA A MENSAGEM
        res.status(201).json({mensagem:"Dados recebidos com sucesoo",});
    }catch(error){
